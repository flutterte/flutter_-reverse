...
.method public clipboardHasStrings()Z
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->clipboardHasStrings()Z
...
.method public getClipboardData(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$ClipboardContentFormat;)Ljava/lang/CharSequence;
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->getClipboardData(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$ClipboardContentFormat;)Ljava/lang/CharSequence;
...
.method public playSystemSound(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SoundType;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->playSystemSound(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SoundType;)V
...
.method public popSystemNavigator()V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->popSystemNavigator()V
...
.method public restoreSystemUiOverlays()V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->restoreSystemChromeSystemUIOverlays()V
...
.method public setApplicationSwitcherDescription(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$AppSwitcherDescription;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromeApplicationSwitcherDescription(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$AppSwitcherDescription;)V
...
.method public setClipboardData(Ljava/lang/String;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setClipboardData(Ljava/lang/String;)V
...
.method public setPreferredOrientations(I)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromePreferredOrientations(I)V
...
.method public setSystemUiChangeListener()V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromeChangeListener()V
...
.method public setSystemUiOverlayStyle(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SystemChromeStyle;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromeSystemUIOverlayStyle(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SystemChromeStyle;)V
...
.method public showSystemOverlays(Ljava/util/List;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromeEnabledSystemUIOverlays(Ljava/util/List;)V
...
.method public showSystemUiMode(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SystemUiMode;)V
    ...
    # invokes: Lio/flutter/plugin/platform/PlatformPlugin;->setSystemChromeEnabledSystemUIMode(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SystemUiMode;)V
